...
export default function BasicFormDemo() {
  ...
  const handleButtonClick = () => {
    ...
    setClickCount((previous) => previous + 1); // lebih direkomendasikan dari diatas
  };
  ...
  const handleFormChange = (event) => {
    ...
    // setFormData(event.target.value); // tidak bisa lakukan seperti ini
  ...
  return (
    ...
    >
      ...
      >
        ...
        {text && (
          <p>
            <strong>Live Output:</strong> {text}
          </p>
        )}
      </section>
      ...
      <section style={{ marginBottom: "16px" }}>
        ...
        <p>
          Fill out the fields below. Notice how all inputs use a single state
          object.
        </p>
        ...
        {submittedData && (
          ...
          >
            ...
            <p>
              <strong>Favorite Color:</strong> {submittedData.favoriteColor}
            </p>
          </div>
        )}
      </section>
