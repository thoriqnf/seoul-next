...
export default function ClientApisPage() {
  ...
  useEffect(() => {
    // Correct way: Safe browser-only checks inside useEffect (never in body of render)
    if (typeof window !== "undefined") {
      setBrowserWidth(window.innerWidth);

      const status = localStorage.getItem("isLoggedIn") === "true" ? "Logged In" : "Not Logged In";
